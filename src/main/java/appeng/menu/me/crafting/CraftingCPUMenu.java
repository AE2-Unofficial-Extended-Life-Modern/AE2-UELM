...
public class CraftingCPUMenu extends AEBaseMenu {
    ...
    private static final String ACTION_TOGGLE_SUSPEND = "toggleSuspend";
    ...
    public CraftingCPUMenu(MenuType<?> menuType, int id, Inventory ip, Object te) {
        ...
        registerClientAction(ACTION_TOGGLE_SUSPEND, this::toggleSuspend);
    }
    ...
    public void toggleSuspend() {
        if (isClientSide()) {
            sendClientAction(ACTION_TOGGLE_SUSPEND);
