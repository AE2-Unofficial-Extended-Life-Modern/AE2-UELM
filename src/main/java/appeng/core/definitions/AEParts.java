...
public final class AEParts {
    ...
    public static final ItemDefinition<PartItem<FilterTerminalPart>> FILTER_TERMINAL = createPart("ME Filter Terminal",
            AEPartIds.FILTER_TERMINAL, FilterTerminalPart.class, FilterTerminalPart::new);
