...
public enum GuiText implements LocalizationEnum {
    ...
    FilterTerminal("ME Filter Terminal"),
    FilterTerminalShort("Filter Terminal"),
    FilterTerminalNameSearch("Search target names"),
    FilterTerminalConfiguredSearch("Search configured resources"),
